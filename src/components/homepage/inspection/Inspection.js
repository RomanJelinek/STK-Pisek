  ...
  return (
    <>
      ...
      <div className={styles.inspectionContainer}>
        ...
        <p>
          V zadní části areálu Vám budou nejprve změřeny emise. Poté se přesuňte
          do kanceláře u vjezdu STK, kde odevzdáte potřebné doklady a budete
          zařazeni mezi čekající vozidla. Pořadí se určuje dle času odevzdání
          dokladů. Viz video níže.
        </p>
        ...
        <p>
          ...
          BRC, LANDI RENZO, LOVATO, ZAVOLI, AUTRONIC, KME, EUROPEGAS, STAG, ESGI
        </p>
